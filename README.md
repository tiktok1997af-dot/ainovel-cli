...
> 📖 **Xem toàn bộ hướng dẫn sử dụng tiếng Việt chi tiết tại [HUONG_DAN_SU_DUNG.md](HUONG_DAN_SU_DUNG.md)**
>
> 🇻🇳 **Giao diện TUI**: Việt hóa 100% thân thiện, tự nhiên.
> 🌐 **Ngôn ngữ sáng tác**: Tùy chọn viết truyện bằng **Tiếng Việt** (mặc định) hoặc **Tiếng Trung** (`"language": "vi" | "zh"`).
> 🦙 **Hỗ trợ Ollama Local**: Chạy 100% offline, miễn phí trên GPU nội bộ.
